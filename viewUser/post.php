        ...
        <div class="container_main">
            <div class="header_main">
                <div class="main_nav">
                    ...
                    <a href="" class="main_nav_link">All Posts</a>
                </div>
                        ...
                        <ul class="list_page">
                            <?php
                                if($pageNumber > 1) {
                                    ...
                                    echo '<li class="page_item"><a href="?act=post&page='.$prePage.'" class="page_item_link" ><i class="bx bx-chevron-left" ></i></a></li>';
                                }
                            ?>
                            <?php
                                if($pages <= 1) {
                                    echo '<li class="page_item"><a href="?act=post&page=1" class="page_item_link">1</a></li>';
                                } else {
                                    for($i = 1; $i <= $pages; $i++) {
                                        if($pageNumber == $i) {
                                            echo '<li class="page_item active"><a href="?act=post&page='.$i.'" class="page_item_link">'.$i.'</a></li>';
                                        } else {
                                            echo '<li class="page_item"><a href="?act=post&page='.$i.'" class="page_item_link">'.$i.'</a></li>';
                                        }
                                    }
                                }
                            ?>
                            <?php
                                if($pageNumber < $pages) {
                                    ...
                                    echo '<li class="page_item"><a href="?act=post&page='.$nextPage.'" class="page_item_link"><i class="bx bx-chevron-right"></i></a></li>';
                                }
                            ?>
                        </ul>
                    </div>
